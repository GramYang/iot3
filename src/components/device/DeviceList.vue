...
<script>
    ...
    export default {
        ...
        created(){
            this.deviceListKey=this.$route.query
        ...
        methods:{
            ...
            handlePageChange(val){
                this.pageNow=val
                this.deviceListKey.page=val.toString()
                this.queryDeviceList()
            },
            queryDeviceList(){
                this.loading=true
                this.$http({
                    url:'/operations/device/queryList',
                    params:this.deviceListKey,
                    method:'get'
                }).then((response)=>{
                    this.loading=false
                    if(response.data && response.status===200){
                        ...
                        this.deviceList=response.data.result.list
                        this.pageNow=response.data.result.pageNum
